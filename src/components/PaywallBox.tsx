...
export function PaywallBox() {
  const benefits = [
    ...
    "Monatlich oder jährlich abonnieren",
    "Jederzeit kündbar",
    "Sichere Zahlung in der echten Version",
  ];
  ...
  return (
    <aside className="my-10 border-2 border-brand-700 bg-brand-50 p-6 sm:p-8">
      ...
      <h2 className="mt-2 font-serif text-3xl font-bold leading-tight text-ink">
        Dieser Artikel ist Teil des Digitalabos
      </h2>
      <p className="mt-4 leading-7 text-ink/80">
        Mit einem Digitalabo lesen Sie alle Premium-Artikel des Unter-Emmentalers
        und unterstützen die regionale Berichterstattung.
      </p>
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        <Link className="btn btn-secondary" to="/projekt">
          Mehr zum Prototyp
        </Link>
      </div>
